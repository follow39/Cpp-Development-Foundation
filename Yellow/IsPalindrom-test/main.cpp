...
void TestAll() {
    ...
    Assert(IsPalindrom("a"), "a string");
    Assert(!IsPalindrom("abcdefg"), "Empty string");
    Assert(IsPalindrom("maam"), "maam string");
    Assert(IsPalindrom("madam"), "madam string");
    Assert(!IsPalindrom("Madam"), "Madam string");
    Assert(!IsPalindrom(" madam"), "_madam string");
